...
- Added a `final_only` option to `Console.export_svg` / `Console.save_svg` so exports can capture just the last rendered `Live` frame instead of every recorded update https://github.com/Textualize/rich/issues/3813
